...
export declare const DTE_BUCKETS: DteBucket[];
...
export type PreferredStructure = 'bull_call_debit_spread' | 'bear_put_debit_spread' | 'call_credit_spread' | 'put_credit_spread' | 'avoid_long_premium' | 'continuation_possible' | 'mean_reversion_fade' | 'premium_selling_favorable' | 'no_clear_edge';
export type WarningFlagSeverity = 'low' | 'medium' | 'high';
export type WarningFlagName = 'earnings_within_7d' | 'earnings_within_14d' | 'low_float' | 'wide_bid_ask' | 'unusual_iv_spike' | 'abnormal_volume' | 'split_recent' | 'insufficient_history' | 'poor_liquidity' | 'unstable_extension_ratio' | 'missing_iv' | 'no_chain';
...
export declare const EXTENSION_MILD_LO = 1;
export declare const EXTENSION_EXTENDED_LO = 1.5;
export declare const EXTENSION_EXTREME_LO = 2;
